    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-2/4 w-full mx-auto overflow-auto">
            <div class="flex items-center justify-between mb-2">
                <h1 class="text-2xl font-medium title-font mb-2 text-gray-900">商品編集</h1>
            </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input value="{{$product->price}}" min="1" type="number" id="price" name="price"
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input value="{{$product->stock}}" min="0" type="number" id="stock" name="stock"
                                   class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                        @error('stock')
                            <div class="text-red-400 text-sm">{{$message}}</div>
                    ...
                    @if($product->image)
                        <div class="p-2 w-full">
                            ...
                            <div class="p-2 w-full">
                                <button class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"><a href="{{route('admin.product.destroyImage', $product->id)}}">イメージ削除</a></button>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="p-2 w-full">
                        <button type="submit" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">保存</button>
                    </div>
                </div>
            </form>
        </div>
